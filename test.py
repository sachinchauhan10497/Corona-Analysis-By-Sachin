...
#India data
data = [0, 2, 1, 22, 2, 1, 3, 5, 9, 15, 7, 12, 9, 16, 6, 14, 19, 25, 28, 59, 76, 69, 102, 66, 86, 78, 151, 143, 110, 160]
...
plt.xlabel('Time in Days since 1st March \n Created By Sachin Chauhan', fontsize=20)
plt.ylabel('Number of Corona Positive Cases Reported', fontsize=20)
plt.title("Covid-19 in India \n Source - covid19india.org/" , fontsize=25)
plt.grid()
plt.show()